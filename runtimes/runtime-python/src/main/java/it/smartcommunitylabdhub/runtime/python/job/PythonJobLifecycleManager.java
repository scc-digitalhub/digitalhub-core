...
@RuntimeComponent(runtime = PythonJobRunSpec.KIND)
public class PythonJobLifecycleManager extends RunLifecycleManager<PythonRunSpec, PythonRunStatus, K8sRunnable> {

    PythonJobLifecycleManager(PythonRuntime runtime) {
        super(runtime);
    }
}
