...
@Slf4j
public class OpeninferenceBuildRunner extends PythonBaseBuildRunner {

    public static final int MIN_IMAGE_NAME_LENGTH = 3;

    public OpeninferenceBuildRunner(PythonProperties properties, K8sBuilderHelper k8sBuilderHelper) {
    ...
    public K8sContainerBuilderRunnable produce(Run run, Map<String, String> secretData) {
        OpeninferenceBuildRunSpec runSpec = new OpeninferenceBuildRunSpec(run.getSpec());
        OpeninferenceBuildTaskSpec taskSpec = runSpec.getTaskBuildSpec();
