...
@Slf4j
public class GuardrailBuildRunner extends PythonBaseBuildRunner {
    ...
    public K8sContainerBuilderRunnable produce(Run run, Map<String, String> secretData) {
        ...
        //define trigger
        HashMap<String, Serializable> triggers = GuardrailContextBuilder.buildTriggers(run, functionSpec);
