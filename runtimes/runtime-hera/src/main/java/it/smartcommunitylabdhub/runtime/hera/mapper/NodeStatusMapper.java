...
package it.smartcommunitylabdhub.runtime.hera.mapper;
...
public class NodeStatusMapper {
    ...
    private static final String LABEL_PREFIX = "hera-digitalhub-runtime-"; // Replace this with the actual prefix
