...
public class OpeninferenceBaseRunner {
    ...
    protected final Resource handlerTemplate = new ClassPathResource("runtime-openinference/docker/openinference-handler.py");
    ...
    public OpeninferenceBaseRunner(
    ...
    protected Context prepareContext(Run run, Map<String, String> secretData, OpeninferenceRunSpec runSpec, K8sFunctionTaskBaseSpec taskSpec, OpeninferenceFunctionSpec functionSpec) {
        ...
        attributes.put("rest_port", HTTP_PORT);
        attributes.put("grpc_port", GRPC_PORT);
        ...
        HashMap<String, Serializable> openinference = new HashMap<>(Map.of("kind", "openinference", "maxWorkers", 4, "attributes", attributes));
        ...
        NuclioFunctionSpec nuclio = NuclioFunctionSpec
            ...
            .handler("_openinference_handler:handler_serve")
            .triggers(triggers)
            .build();
        ...
        if (functionSpec.getSource() != null) {
            ...
            try {            
                ...
                contextSources.add(ContextSource
                        .builder()
                        .name("_openinference_handler.py")
