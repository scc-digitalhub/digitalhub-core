...
// Run spec for the tvm+compile task. Flattens the parent function's spec and the
// compile task spec into a single document (both @JsonUnwrapped) for the runner.
@Getter
@Setter
@NoArgsConstructor
