...
public class ServicegraphRunStatus extends RunBaseStatus {
    ...
    public void configure(Map<String, Serializable> data) {
        ...
        ServicegraphRunStatus spec = mapper.convertValue(data, ServicegraphRunStatus.class);
        this.service = spec.getService();
        this.web = spec.getWeb();
    }

    public static ServicegraphRunStatus with(Map<String, Serializable> data) {
        ServicegraphRunStatus spec = new ServicegraphRunStatus();
        spec.configure(data);
