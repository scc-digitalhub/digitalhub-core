...
@Component
public class ModelEntityBuilder implements Converter<Model, ModelEntity> {
     ...
     * @return ModelDTO
     */
    public ModelEntity build(Model dto) {
        // Extract data
        ...
        return ModelEntity
            ...
            .state(
                ...
                statusFieldAccessor.getState() == null
                    ...
                    : ModelState.valueOf(statusFieldAccessor.getState()).name()
            )
            // Metadata Extraction
    ...
    @Override
    public ModelEntity convert(Model source) {
        return build(source);
    }
}
