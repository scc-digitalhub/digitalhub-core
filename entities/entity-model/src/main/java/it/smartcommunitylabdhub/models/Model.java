...
public class Model implements BaseDTO, MetadataDTO, SpecDTO, StatusDTO, ExtensibleDTO {
    ...
    public String getKey() {
        ...
        sb.append(Keys.PATH_DIVIDER).append(EntityUtils.getEntityName(Model.class).toLowerCase());
