...
package it.smartcommunitylabdhub.artifacts.builders;

import it.smartcommunitylabdhub.artifacts.Artifact;
import it.smartcommunitylabdhub.artifacts.lifecycle.ArtifactState;
...
public class ArtifactEntityBuilder implements Converter<Artifact, ArtifactEntity> {
    ...
    public ArtifactEntityBuilder(AttributeConverter<Map<String, Serializable>, byte[]> cborConverter) {
        this.converter = cborConverter;
    }

    @Override
    public ArtifactEntity convert(@NonNull Artifact dto) {
        // Extract data
        ...
        return ArtifactEntity
            ...
            .state(
                ...
                statusFieldAccessor.getState() == null
                    ...
                    : ArtifactState.valueOf(statusFieldAccessor.getState()).name()
            )
            // Metadata Extraction
