...
@Component
public class ContainerImageDTOBuilder implements Converter<ContainerImageEntity, ContainerImage> {
    ...
    public ContainerImageDTOBuilder(AttributeConverter<Map<String, Serializable>, byte[]> cborConverter) {
    ...
    @Override
    public ContainerImage convert(@NonNull ContainerImageEntity entity) {
