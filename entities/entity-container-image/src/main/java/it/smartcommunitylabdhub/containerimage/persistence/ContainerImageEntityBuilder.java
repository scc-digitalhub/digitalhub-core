...
@Component
public class ContainerImageEntityBuilder implements Converter<ContainerImage, ContainerImageEntity> {

    private final AttributeConverter<Map<String, Serializable>, byte[]> converter;

    public ContainerImageEntityBuilder(AttributeConverter<Map<String, Serializable>, byte[]> cborConverter) {
        this.converter = cborConverter;
    }

    @Override
    public ContainerImageEntity convert(@NonNull ContainerImage dto) {
        // Extract data
        ...
        return ContainerImageEntity.builder()
            ...
            .state(
                ...
                statusFieldAccessor.getState() == null
                    ...
                    : ContainerImageState.valueOf(statusFieldAccessor.getState()).name()
            )
            // Metadata Extraction
            .created(
