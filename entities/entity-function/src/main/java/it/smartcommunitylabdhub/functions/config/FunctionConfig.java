...
package it.smartcommunitylabdhub.functions.config;
...
public class FunctionConfig {
    ...
    @Bean
    EntityIndexer<Function> functionEntityIndexer(Optional<EntityIndexer.Factory> entityIndexerFactory) {
        return entityIndexerFactory.map(factory -> factory.build(Function.class)).orElse(null);
    }
}
