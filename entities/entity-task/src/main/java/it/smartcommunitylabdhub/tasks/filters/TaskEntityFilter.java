...
package it.smartcommunitylabdhub.tasks.filters;
...
@AllArgsConstructor
@NoArgsConstructor
public class TaskEntityFilter extends AbstractEntityFilter<Task> {
    ...
    @Override
    public SearchFilter<Task> toSearchFilter() {
        List<SearchCriteria<Task>> criteria = new ArrayList<>();
