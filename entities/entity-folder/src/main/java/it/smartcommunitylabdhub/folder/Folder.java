...
package it.smartcommunitylabdhub.folder;
...
public class Folder implements BaseDTO, MetadataDTO, SpecDTO, StatusDTO {
    ...
    public String getKey() {
        ...
        sb.append(Keys.PATH_DIVIDER).append(EntityUtils.getEntityName(Folder.class).toLowerCase());
