...
@Component
public class FolderDTOBuilder implements Converter<FolderEntity, Folder> {
    ...
    public FolderDTOBuilder(AttributeConverter<Map<String, Serializable>, byte[]> cborConverter) {
    ...
    @Override
    public Folder convert(@NonNull FolderEntity entity) {
