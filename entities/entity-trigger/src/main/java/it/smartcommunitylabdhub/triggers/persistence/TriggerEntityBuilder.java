...
public class TriggerEntityBuilder implements Converter<Trigger, TriggerEntity> {
    ...
    public TriggerEntityBuilder(AttributeConverter<Map<String, Serializable>, byte[]> cborConverter) {
    ...
    public TriggerEntity build(Trigger dto) {
        ...
        return TriggerEntity
            ...
            .state(
                ...
                statusFieldAccessor.getState() == null ? TriggerState.CREATED.name() : statusFieldAccessor.getState()
            )
