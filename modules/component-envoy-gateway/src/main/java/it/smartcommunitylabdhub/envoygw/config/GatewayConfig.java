...
import it.smartcommunitylabdhub.envoygw.GatewayCRManager;
...
@EnableConfigurationProperties({ EnvoyGwProperties.class, PayloadLoggerProperties.class })
public class GatewayConfig {

    @Bean
    public GatewayCRManager gatewayCRManager(EnvoyGwProperties envoyGwProperties) {
        return new GatewayCRManager(envoyGwProperties);
    }
}
