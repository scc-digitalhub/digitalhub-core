...
/*
 * Store for persisting resource metrics
 */
public interface ResourceMetricsStore {
    @Nullable
    ResourceMetrics findResourceMetrics(@NotNull String id) throws SystemException;

    ResourceMetrics createResourceMetrics(@NotNull ResourceMetrics resourceMetrics)
        throws DuplicatedEntityException, BindException, IllegalArgumentException, SystemException;

    ResourceMetrics updateResourceMetrics(@NotNull String id, @NotNull ResourceMetrics resourceMetrics)
