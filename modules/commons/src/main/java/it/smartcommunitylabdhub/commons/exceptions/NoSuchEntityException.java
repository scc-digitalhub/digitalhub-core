...
public class NoSuchEntityException extends RuntimeException {
    ...
    public NoSuchEntityException(Class<?> entity) {
        super(build(entity.getSimpleName().toLowerCase()));
    }

    public NoSuchEntityException(Class<?> entity, Throwable cause) {
        super(build(entity.getSimpleName().toLowerCase()), cause);
    }
