...
public class Workflow implements BaseDTO, MetadataDTO, SpecDTO, StatusDTO {
    ...
    @NotNull
    @Pattern(regexp = Keys.SLUG_PATTERN) //TODO update to name pattern, requires task and run rels to be aligned
    private String name;
