...
public class DuplicatedEntityException extends Exception {
    ...
    public DuplicatedEntityException(Class<?> entity, String id) {
        super(build(entity.getSimpleName().toLowerCase(), id));
    }

    public DuplicatedEntityException(Class<?> entity, String id, Throwable cause) {
        super(build(entity.getSimpleName().toLowerCase(), id), cause);
    }
}
