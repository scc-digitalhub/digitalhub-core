...
public class ExtensionDefinition implements BaseDTO, SpecDTO, StatusDTO {
    ...
    public String getKey() {
        ...
        sb.append(Keys.PATH_DIVIDER).append(EntityUtils.getEntityName(ExtensionDefinition.class).toLowerCase());
