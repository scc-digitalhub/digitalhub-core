...
@Setter
@NoArgsConstructor
@SpecType(runtime = FlowerClientRuntime.RUNTIME, kind = FlowerClientBuildRunSpec.KIND, entity = EntityName.RUN)
public class FlowerClientBuildRunSpec extends FlowerClientRunSpec {
    ...
    public FlowerClientBuildRunSpec(Map<String, Serializable> data) {
        configure(data);
    }
