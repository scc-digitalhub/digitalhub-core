 ...
 *
 * @RunnerComponent(runtime = "hera", task = "build")
 */
public class HeraBuildRunner {

    private final String image;
    private final Map<String, String> secretData;

    public HeraBuildRunner(String image, Map<String, String> secretData) {
        this.image = image;
        this.secretData = secretData;
    }

    public K8sRunnable produce(Run run) {
        HeraBuildRunSpec runSpec = new HeraBuildRunSpec(run.getSpec());
        HeraBuildTaskSpec taskSpec = runSpec.getTaskBuildSpec();
