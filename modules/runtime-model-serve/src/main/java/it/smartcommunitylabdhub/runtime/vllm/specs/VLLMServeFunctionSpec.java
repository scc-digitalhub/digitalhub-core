...
public class VLLMServeFunctionSpec extends FunctionBaseSpec {
    ...
    public static VLLMServeFunctionSpec with(Map<String, Serializable> data) {
        VLLMServeFunctionSpec spec = new VLLMServeFunctionSpec();
        spec.configure(data);
        return spec;
    }
}
