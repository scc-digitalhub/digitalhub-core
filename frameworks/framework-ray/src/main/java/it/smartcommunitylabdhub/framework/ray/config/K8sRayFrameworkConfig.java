...
public class K8sRayFrameworkConfig {
    ...
    public RunnableStore<K8sRayJobRunnable> k8sRayJobRunnableStore(RunnableRepository runnableRepository) {
        return new RunnableStoreImpl<>(K8sRayJobRunnable.class, runnableRepository);
    }

    @Bean
    @ConditionalOnKubernetes
    public RunnableStore<K8sRayServiceRunnable> k8sRayServiceRunnableStore(RunnableRepository runnableRepository) {
        return new RunnableStoreImpl<>(K8sRayServiceRunnable.class, runnableRepository);
    }
