...
@Service
@Slf4j
public class UserAuthenticationManagerBuilderImpl implements UserAuthenticationManagerBuilder {
    ...
    public UserAuthenticationManager build(List<AuthenticationProvider> authProviders) {
        UserAuthenticationManagerImpl manager = new UserAuthenticationManagerImpl(authProviders);
