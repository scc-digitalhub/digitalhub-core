...
@Slf4j
@Component
public class RunStatusProcessorRegistry extends ProcessorRegistryImpl<Run, Status> {

    public RunStatusProcessorRegistry(ApplicationContext applicationContext) {
