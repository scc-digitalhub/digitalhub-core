...
public class RuntimeFactory {
    ...
    private final Map<
        String,
        Runtime<? extends RunBaseSpec, ? extends RunBaseStatus, ? extends RunRunnable>
    > runtimeMap;
    ...
    private String getRuntimeFromAnnotation(
        Runtime<? extends RunBaseSpec, ? extends RunBaseStatus, ? extends RunRunnable> runtime
    ) {
     ...
     */
    public Runtime<? extends RunBaseSpec, ? extends RunBaseStatus, ? extends RunRunnable> getRuntime(String runtime) {
        Runtime<? extends RunBaseSpec, ? extends RunBaseStatus, ? extends RunRunnable> concreteRuntime = runtimeMap.get(
            runtime
        );
